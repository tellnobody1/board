  ...
  var getBlob = function (url) {
      return function (headers) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              responseFormat: Affjax_ResponseFormat.blob,
              ...
              return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
                  if (resp instanceof Data_Either.Left) {
                      return new Data_Either.Left("Request failed: " + Affjax.printError(resp.value0));
                  };
                  ...
                  if (resp instanceof Data_Either.Right) {
                      return new Data_Either.Left("Request failed: " + Data_Show.show(Data_Show.showInt)(resp.value0.status));
                  };
                  throw new Error("Failed pattern match at Lib.Ajax (line 38, column 10 - line 41, column 82): " + [ resp.constructor.name ]);
              })());
          });
      };
  };
  var getBlobEff = function (url) {
      return function (headers) {
          return function (success) {
              var f = function (v) {
                  if (v instanceof Data_Either.Left) {
                      return Data_Functor["void"](Effect.functorEffect)(Effect_Class_Console.errorShow(Effect_Class.monadEffectEffect)(Effect_Exception.showError)(v.value0));
                  };
                  if (v instanceof Data_Either.Right && v.value0 instanceof Data_Either.Left) {
                      return Data_Functor["void"](Effect.functorEffect)(Effect_Class_Console.errorShow(Effect_Class.monadEffectEffect)(Data_Show.showString)(v.value0.value0));
                  };
                  ...
                  throw new Error("Failed pattern match at Lib.Ajax (line 46, column 5 - line 46, column 58): " + [ v.constructor.name ]);
              };
              return Effect_Aff.runAff_(f)(getBlob(url)(headers));
          };
      };
  };
  var get = function (url) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.string)(url))(function (resp) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
              if (resp instanceof Data_Either.Left) {
                  return new Data_Either.Left("Request failed: " + Affjax.printError(resp.value0));
              };
              ...
              if (resp instanceof Data_Either.Right) {
                  return new Data_Either.Left("Request failed: " + (Data_Show.show(Data_Show.showInt)(resp.value0.status) + (", b:" + resp.value0.body)));
              };
              throw new Error("Failed pattern match at Lib.Ajax (line 22, column 10 - line 25, column 106): " + [ resp.constructor.name ]);
          })());
      });
  };
  var getEff = function (url) {
      return function (success) {
          var f = function (v) {
              ...
              throw new Error("Failed pattern match at Lib.Ajax (line 30, column 5 - line 30, column 60): " + [ v.constructor.name ]);
          };
          return Effect_Aff.runAff_(f)(get(url));
      };
  };
  exports["getEff"] = getEff;
  exports["getBlobEff"] = getBlobEff;
})(PS);
(function(exports) {
...
})(PS["Lib.Peer"] = PS["Lib.Peer"] || {});
(function($PS) {
  // Generated by purs version 0.14.9
  "use strict";
  $PS["Lib.Peer"] = $PS["Lib.Peer"] || {};
  var exports = $PS["Lib.Peer"];
  var $foreign = $PS["Lib.Peer"];
  exports["initPeer"] = $foreign.initPeer;
  exports["onData"] = $foreign.onData;
  exports["sendData"] = $foreign.sendData;
})(PS);
(function(exports) {
  /* global exports */
  "use strict";
...
(function($PS) {
  ...
  var Effect = $PS["Effect"];
  var Effect_Exception = $PS["Effect.Exception"];
  var Lib_Ajax = $PS["Lib.Ajax"];
  var Lib_Peer = $PS["Lib.Peer"];
  ...
  var appClass = (function () {
      ...
      var showCard = function (v) {
          return function (card) {
              return Control_Applicative.pure(Effect.applicativeEffect)(React_DOM.div([ Lib_React.cn("col") ])([ React_DOM.div([ Lib_React.cn("card") ])([ showImage(card.image), React_DOM.div([ Lib_React.cn("card-img-overlay") ])([ React_DOM.h5([ Lib_React.cn("card-title bg-dark d-inline px-2 py-1") ])([ React_DOM.text(card.title) ]) ]) ]) ]));
          };
      };
      var showCards = function ($$this) {
          return function __do() {
              var state = React.getState($$this)();
              var rows = Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Functor.map(Data_Functor.functorArray)(showCard($$this))(state.cards))();
              return React_DOM.div([ Lib_React.cn("row row-cols-1 row-cols-md-3 g-4 mt-0") ])(rows);
          };
      };
      var setLang = function ($$this) {
          return function (lang) {
              return Lib_Ajax.getEff("langs/" + (lang + ".js"))(function (v) {
      ...
      var fetchImage = function ($$this) {
          return function (index) {
              return function __do() {
                  var props = React.getProps($$this)();
                  return Lib_Ajax.getBlobEff(props.imagePath)(props.imageHeaders)(function (v) {
                      return function __do() {
                          var url = Web_File_Url.createObjectURL(v)();
                          return React.modifyState($$this)(function (s) {
                              return {
                                  lang: s.lang,
                                  keyText: s.keyText,
                                  cards: Data_Maybe.fromMaybe(s.cards)(Data_Array.modifyAt(index)(function (v2) {
                                      return {
                                          image: new Data_Maybe.Just(url),
                                          title: v2.title
                                      };
                                  })(s.cards)),
                                  question: s.question
      ...
      var fetchImages = function ($$this) {
          return function __do() {
              var state = React.getState($$this)();
              return Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_FunctorWithIndex.mapWithIndex(Data_FunctorWithIndex.functorWithIndexArray)(function (i) {
                  return function (v) {
                      return fetchImage($$this)(i);
                  };
              })(state.cards))();
          };
      };
      var showForm = function ($$this) {
          return function __do() {
              var state = React.getState($$this)();
              var props = React.getProps($$this)();
              return React_DOM.div([ Lib_React.cn("row") ])([ React_DOM.div([ Lib_React.cn("col") ])([ React_DOM.div([ Lib_React.cn("input-group") ])([ React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props.placeholder(state.keyText("question")), React_DOM_Props.autoFocus(true), React_DOM_Props.value(state.question), Lib_React.onChangeValue(function (v) {
                  return React.modifyState($$this)(function (v1) {
                      return {
                          lang: v1.lang,
                          keyText: v1.keyText,
              ...
              }) ]), React_DOM.button([ React_DOM_Props["_type"]("button"), Lib_React.cn("btn btn-primary"), React_DOM_Props.onClick(function (v) {
                  return function __do() {
                      Lib_Peer.sendData(props.peer)(state.question)();
                      React.modifyState($$this)(function (s) {
                          return {
                              lang: s.lang,
                              keyText: s.keyText,
                              cards: Data_Array.cons({
                      ...
                      return fetchImage($$this)(0)();
                  };
              }) ])([ React_DOM.text(state.keyText("post")) ]) ]) ]) ]);
          };
      };
      var render = function ($$this) {
          return function __do() {
              var form = showForm($$this)();
              var cards = showCards($$this)();
              return React_DOM.div([ Lib_React.cn("container mt-3 mt-md-4") ])([ form, cards ]);
          };
      };
      return React.component()("App")(function ($$this) {
          return Control_Applicative.pure(Effect.applicativeEffect)({
              ...
              componentDidMount: function __do() {
                  setLang($$this)("uk")();
                  var props = React.getProps($$this)();
                  Lib_Peer.onData(props.peer)(function (x) {
                      return React.modifyState($$this)(function (s) {
                          return {
                              lang: s.lang,
                              keyText: s.keyText,
                  ...
                  return Data_Functor["void"](Effect.functorEffect)(fetchImages($$this))();
              }
          });
      });
  })();
  var main = function __do() {
      ...
      var peer = Lib_Peer.initPeer("localhost")(9000)("/myapp")();
      var props = {
      ...
      var element = React.createLeafElement()(appClass)(props);
