  ...
  var get = function (url) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.string)(url))(function (resp) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
              ...
              if (resp instanceof Data_Either.Right && resp.value0.status === 0) {
                  return new Data_Either.Right(resp.value0.body);
              };
              ...
              throw new Error("Failed pattern match at Lib.Ajax (line 40, column 10 - line 44, column 106): " + [ resp.constructor.name ]);
          })());
      });
  };
  var getEff = function (url) {
      return function (success) {
          var f = function (v) {
              ...
              throw new Error("Failed pattern match at Lib.Ajax (line 49, column 5 - line 49, column 60): " + [ v.constructor.name ]);
          };
  ...
  var appClass = (function () {
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.text(state.keyText("uk")) ]);
          };
      };
